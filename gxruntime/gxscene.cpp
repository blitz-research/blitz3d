...
void gxScene::setTexState( int n,const TexState &state,bool tex_blend ){
	...
	setTSS( n,D3DTSS_MIPFILTER, (flags & gxCanvas::CANVAS_TEX_BILINEAR) ? D3DTFP_POINT : D3DTFP_LINEAR);
	setTSS( n,D3DTSS_MINFILTER, (flags & gxCanvas::CANVAS_TEX_NOFILTER) ? D3DTFN_POINT : D3DTFN_LINEAR);
	setTSS( n,D3DTSS_MAGFILTER, (flags & gxCanvas::CANVAS_TEX_NOFILTER) ? D3DTFG_POINT : D3DTFG_LINEAR);
	setTSS( n,D3DTSS_MIPFILTER, (flags & gxCanvas::CANVAS_TEX_NOFILTER) ? D3DTFP_NONE : D3DTFP_LINEAR);
	...
	setTSS( n,D3DTSS_MAXANISOTROPY, ((flags & gxCanvas::CANVAS_TEX_ANISOTROPIC) && (textureAnisotropic>0)) ? textureAnisotropic : 1);
